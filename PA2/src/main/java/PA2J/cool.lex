...
<COMMENT,YYINITIAL>{MULTILINE_COMMENT_BEGIN}  {
			yybegin(COMMENT);
			commentLength++;
}
...
<YYINITIAL>{MULTILINE_COMMENT_END}        { return new Symbol(TokenConstants.ERROR, "Closing character not found"); }
<YYINITIAL>{SINGLE_COMMENT_LINE}         { ; }
<COMMENT>{CHAR}                   { ; }
<YYINITIAL>{SPACE}            { ; }

<YYINITIAL>{TYPE_IDENTIFIER}               { return new Symbol(TokenConstants.TYPEID, new IdSymbol(yytext(), yytext().length(), yytext().hashCode())); }
<YYINITIAL>{OBJECT_IDENTIFIER}                { return new Symbol(TokenConstants.OBJECTID, new IdSymbol(yytext(), yytext().length(), yytext().hashCode())); }
...
<YYINITIAL>{PLUS_SIGN}                    { return new Symbol(TokenConstants.PLUS); }
<YYINITIAL>{SUBTRACTION_SIGN}                 { return new Symbol(TokenConstants.MINUS); }
<YYINITIAL>{MULTIPLICATION_SIGN}              { return new Symbol(TokenConstants.MULT); }
<YYINITIAL>\{DIVISION_SIGN}                 { return new Symbol(TokenConstants.DIV); }

<YYINITIAL>{EQUAL_SIGN}                   { return new Symbol(TokenConstants.EQ); }
<YYINITIAL>{LESS_SIGN}                   { return new Symbol(TokenConstants.LT); }
<YYINITIAL>{LESS_EQUAL_SIGN}              { return new Symbol(TokenConstants.LE); }
<YYINITIAL>{NEGATIVE_SIGN}                { return new Symbol(TokenConstants.NEG); }

<YYINITIAL>{SEMICOLON}            { return new Symbol(TokenConstants.SEMI); }
<YYINITIAL>{COLON}              { return new Symbol(TokenConstants.COLON); }
<YYINITIAL>{POINT}                   { return new Symbol(TokenConstants.DOT); }
<YYINITIAL>{COMA}                 { return new Symbol(TokenConstants.COMMA); }

<YYINITIAL>{LEFT_PARENTHESIS}          { return new Symbol(TokenConstants.LPAREN); }
<YYINITIAL>{RIGHT_PARENTHESIS}         { return new Symbol(TokenConstants.RPAREN); }
<YYINITIAL>{RIGHT_CURLY_BRACE}               { return new Symbol(TokenConstants.LBRACE); }
<YYINITIAL>{LEFT_CURLY_BRACE}              { return new Symbol(TokenConstants.RBRACE); }
